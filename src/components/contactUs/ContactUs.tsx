    ...
    <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
        ...
        onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
            ...
            <div className="mt-10 justify-between gap-8 md:flex">
                ...
                target="_blank" 
                onSubmit={onSubmit}
                action="https://formsubmit.co/943f3feba96fcee0bd2b8b8a0ecfd362"
                method="POST">
                    ...
                    {errors.name && (
                        <p className="mt-1 text-primary-500">
                            ...
                            {errors.name.type === "maxLength" && "Max lenght is a 100 char."}
                        </p>
                    )}
                    <input className={inputStyles} 
                    type="text" 
                    ...
                    {errors.message && (
                        <p className="mt-1 text-primary-500">
                            ...
                            {errors.message.type === "maxLength" && "Max lenght is a 200 char."}
                        </p>
                    )}
                    <button 
                    type="submit" 
                ...
                variants={{
                    ...
                    className="md:before:content-evolvetext w-full before:absolute before:-bottom-20 before:-right-10 before:z-[-1]">
                        ...
                        alt="contactus-page-graphic" src={ContactUsGraphic}
                        />
                    </div>
                </motion.div>
            </div>
